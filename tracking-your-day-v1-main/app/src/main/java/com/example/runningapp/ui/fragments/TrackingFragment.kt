...
import com.example.runningapp.utilities.Constants.MAPVIEW_BUNDLE_KEY
    ...
    */
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(savedInstanceState != null) {
            val cancelRunDialog = parentFragmentManager.findFragmentByTag(CANCEL_DIALOG_TAG)
...
//            }
    ...
    private fun endRunAndSaveToDB() {
        map?.snapshot { bmp ->
            ...
            val caloriesBurned = ((distanceInMeters / 1000f) * 15f).toInt()
            val run = RunObject(bmp, timestamp, avgSpeed, distanceInMeters, curTimeInMillis, caloriesBurned)
